    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-6 rounded shadow-lg w-1/3">
                ...
                <div className="mt-4">
                    <p>Це назавжди видалить &nbsp;
                        <span className="font-semibold">{session?.data?.organization}</span> деталі організації,
                        проекти, команда, робочі елементи та всі дані, пов'язані з цією організацією.</p>
                </div>
                <div className="mt-4">
                ...
                <div className="mb-5 mx-4 mt-4">
                    <label className="text-sm mb-1">
                        Тип <span className="font-semibold">{session?.data?.organization}</span> нижче для підтвердження
                    </label>
                    <input
                        type="text"
                        value={orgName}
                ...
                <div className="mt-7 flex justify-end">
                    <div className="flex">
                        ...
                        {disabled ? (
                            ...
                            >
                                <span> Я розумію, видалити акаунт</span>

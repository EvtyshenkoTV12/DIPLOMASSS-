                        ...
                        <div className="my-4 flex justify-center">
                            {column?.title === "Product Backlog" ? (
                                <div className="text-md text-left mt-4 ml-10">
                                    <h2 className="text-md font-semibold mb-1">Створіть беклог проекту</h2>
                                    <p className="text-gray-700">
                                        Додайте робочі елементи, натиснувши - Додати робочий елемент
                                        <br />
                                        або імпортуйте робочі елементи з{" "}
                                ...
                                <div className="text-md text-left mt-4 ml-10">
                                    ...
                                    <p className="text-gray-700">
                                        Додайте робочі елементи, натиснувши - Додати робочий елемент
                                        <br />
                                        або перетягніть робочі елементи з журналу черги продукту
                                    </p>
                                </div>
                            )}

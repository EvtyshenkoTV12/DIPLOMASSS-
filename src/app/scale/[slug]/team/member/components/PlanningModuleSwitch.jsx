            ...
            <div className="w-full bg-blue-100 text-black py-2 px-4 top-0 left-0 flex justify-center items-center relative mb-7 rounded-md">
                <div className="flex-grow text-center">
                    <p className="text-sm md:text-base mx-6">
                       Будь ласка, попросіть учасника вийти та знову увійти, щоб переглянути оновлений розподіл проекту.
                    </p>
                </div>
            </div>
            <h2 className="text-lg font-semibold mb-4">Виберіть Активні проекти</h2>

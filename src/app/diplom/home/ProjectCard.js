                            ...
                            <table className="min-w-full border-collapse">
                                <thead>
                                    <tr className="bg-slate-100">
                                        <th className="px-4 py-2 font-semibold text-left">Ім'я</th>
                                        <th className="px-4 py-2 font-semibold text-left">емейл</th>
                                        <th className="px-4 py-2 font-semibold text-left">роль</th>
                                        <th className="px-4 py-2 font-semibold text-left">Запрошено</th>
                                        <th className="px-4 py-2 font-semibold text-left">Долучився</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {projectMembers.map(member => (
                                        <tr key={member._id} className="border-t">
                                            ...
                                            <td className="px-4 py-2 border text-left">{member.isInvited ? <span>Запрошено</span> : <span> - </span>}</td>
                                            <td className="px-4 py-2 border text-left">{member.isJoined ? <span>Долучився</span> : <span>Not Joined</span>}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>

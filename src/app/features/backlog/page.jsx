                            ...
                            <div className="mx-4 md:mx-16 flex flex-col md:flex-row">
                                <div className="mt-8 md:mt-0 md:ml-8 text-base md:w-1/2">
                                    <div className="pb-3 text-left md:pb-4 md:ml-2 md:mr-2">
                                        ...
                                        >
                                            Ефективно розставляйте пріоритети та керуйте завданнями
                                        </h1>
                                        <div className="mx-auto max-w-3xl">
                                            <p
                                                className="mb-8 text-gray-700 text-lg"
                                            >
                                                Легко організовуйте, розставляйте пріоритети та відстежуйте всі завдання вашого проекту в одному місці, гарантуючи, що нічого не пройде повз увагу.
                                            </p>
                                        </div>
                                        <div>
                                            <div

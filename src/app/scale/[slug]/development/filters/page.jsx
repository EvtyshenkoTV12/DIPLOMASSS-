                            ...
                            <div className="ml-3 mr-3">
                                ...
                                >
                                    <MenuItem onClick={() => handleOpenForm("Backlog")}>
                                        <span className="text-sm mt-[3px]">Робочі предмети</span>
                                    </MenuItem>
                                    <MenuItem onClick={() => handleOpenForm("Release")}>
                                        <span className="text-sm mt-[3px]">Реліз/випуск</span>
                                    </MenuItem>
                                    <MenuItem onClick={() => handleOpenForm("Risk")}>
                                        <span className="text-sm mt-[3px]">рикики</span>
                                    </MenuItem>
                                    <MenuItem onClick={() => handleOpenForm("Assumption")}>
                                        <span className="text-sm mt-[3px]">Припущення</span>
                                    </MenuItem>
                                    <MenuItem onClick={() => handleOpenForm("Issue")}>
                                        <span className="text-sm mt-[3px]">Пиатння</span>
                                    </MenuItem>
                                    <MenuItem onClick={() => handleOpenForm("Dependencies")}>
                                        <span className="text-sm mt-[3px]">Залежності</span>
                                    </MenuItem>
                                    <MenuItem onClick={() => handleOpenForm("Stakeholder")}>
                                        <span className="text-sm mt-[3px]">Зацікавлена ​​сторона</span>
                                    </MenuItem>
                                    <MenuItem onClick={() => handleOpenForm("Retrospective")}>
                                        <span className="text-sm mt-[3px]">перспектива</span>
                                    </MenuItem>
                                    <MenuItem onClick={() => handleOpenForm("Bookmark")}>
                                        <span className="text-sm mt-[3px]">Закладка</span>
                                    </MenuItem>
                                    <MenuItem onClick={() => handleOpenForm("Timer")}>
                                        <span className="text-sm mt-[3px]">Таймер</span>
                                    </MenuItem>
                                </Menu>
                            </div>
                            <div>
